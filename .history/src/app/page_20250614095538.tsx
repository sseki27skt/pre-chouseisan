 ...
 {/* ★ ここに説明文を追加します */}
      ...
      <Card className="mb-4">
        <CardContent className="p-4 flex flex-col items-center">
          <h2 className="text-xl font-semibold mb-2 text-left w-full">1. 日付を選択</h2>
          <div className="w-full max-w-md">
            <Calendar mode="multiple" selected={selectedDates} onSelect={setSelectedDates} className="rounded-md border w-full"/>
          </div>
        </CardContent>
      </Card>
      <Card className="mb-4">
