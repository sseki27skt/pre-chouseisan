...
// 日付選択カード
const DateSelectorCard = ({ selectedDates, onSelect }) => (
  <Card className="mb-4">
...
// 操作ボタン
const ActionControls = ({ onGenerate, onClearAll, showWeekday, onShowWeekdayChange }) => (
...
// 出力カード
const OutputCard = ({ output, onCopyAndGo, isCopied, onCopyOnly, iconCopied }) => (
  <Card>
    <CardContent className="p-4">
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      ...
      <TimeSelectionCard 
        ...
        onSelectionModeChange={(value) => setSelectionMode(value as 'time' | 'period')}
        timeProps={{
          selectedTimes,
          handleTimeChange,
          timeRange,
