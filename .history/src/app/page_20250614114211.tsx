            ...
            <TabsContent value="time" forceMount className="mt-4">
              <div className="p-4 border rounded-lg mb-6 space-y-6">
                <div className="flex justify-between items-center">
                  <h3 className="font-medium">一括選択</h3>
                ...
                <div>
                  ...
                  <Slider id="time-range" value={timeRange} onValueChange={(value) => setTimeRange(value as [number, number])} max={24} min={0} step={0.5} className="my-4"/>
                </div>
                <div>
